...
public class ContractListParser extends EveXMLParser<ContractListResponse>{
	...
	protected void onInit(Digester digester) {
		digester.addObjectCreate("eveapi/result/rowset/row", EveContract.class);		
		digester.addRule("eveapi/result/rowset/row", new SetAttributePropertyRule());					
		digester.addRule("eveapi/result/rowset/row", new SetNextRule("addContract"));
	}	
}
