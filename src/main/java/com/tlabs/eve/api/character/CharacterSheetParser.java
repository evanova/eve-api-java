...
public final class CharacterSheetParser extends EveAPIParser<CharacterSheetResponse> {
	...
	private static final class CreateRowSetRule extends BaseRule {
		...
		public void doEnd(String name) {
			...
			EveCharacter character = (EveCharacter)getDigester().peek();
		...
		private void addSkills(EveCharacter c, List<Map<String, String>> attrs) {
		...
		private void addRoles(EveCharacter c, List<Map<String, String>> attrs, int type) {
			for (Map<String, String> attr: attrs) {
				try {
		...
		private void addTitles(EveCharacter c, List<Map<String, String>> attrs) {
			for (Map<String, String> attr: attrs) {
				try {
		...
		private void addCertificates(EveCharacter c, List<Map<String, String>> attrs) {
			for (Map<String, String> attr: attrs) {
				try {
	...
	protected void onInit(Digester digester) {
		digester.addObjectCreate("eveapi/result", EveCharacter.class);
		...
		digester.addObjectCreate(
				"eveapi/result/attributeEnhancers/intelligenceBonus", EveCharacter.AttributeEnhancer.class);
		digester.addRule(
		...
		digester.addObjectCreate(
				"eveapi/result/attributeEnhancers/memoryBonus", EveCharacter.AttributeEnhancer.class);
		digester.addRule(
		...
		digester.addObjectCreate(
				"eveapi/result/attributeEnhancers/charismaBonus", EveCharacter.AttributeEnhancer.class);
		digester.addRule(
		...
		digester.addObjectCreate(
				"eveapi/result/attributeEnhancers/perceptionBonus", EveCharacter.AttributeEnhancer.class);
		digester.addRule(
		...
		digester.addObjectCreate(
				"eveapi/result/attributeEnhancers/willpowerBonus", EveCharacter.AttributeEnhancer.class);
		digester.addRule(
