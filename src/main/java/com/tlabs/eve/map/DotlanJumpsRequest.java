...
public final class DotlanJumpsRequest extends EveRequest<DotlanRouteResponse> {
    ...
    public static final class Builder {
        ...
        public String buildPage() {
            String r = "/jump/" + shipName + "," + jumpDriveCalibration + "" + jumpFuelConservation + "" + jumpFreighter;
    ...
    public DotlanJumpsRequest(final String fromSolarSystemName, final String toSolarSystemName) {
        super(DotlanRouteResponse.class, Builder.from(fromSolarSystemName, toSolarSystemName).buildPage());
    }
